...
class Value : public ::google::protobuf::Message {
 public:
  ...
  inline ::google::protobuf::int32 indegree() const;
  inline void set_indegree(::google::protobuf::int32 value);
  ...
  inline ::google::protobuf::int32 numtaskfin() const;
  inline void set_numtaskfin(::google::protobuf::int32 value);
 ...
 private:
  ...
  ::google::protobuf::int32 indegree_;
  ...
  ::google::protobuf::int32 numtaskfin_;
...
inline ::google::protobuf::int32 Value::indegree() const {
  return indegree_;
}
inline void Value::set_indegree(::google::protobuf::int32 value) {
  set_has_indegree();
  indegree_ = value;
}
...
inline ::google::protobuf::int32 Value::numtaskfin() const {
  return numtaskfin_;
}
inline void Value::set_numtaskfin(::google::protobuf::int32 value) {
  set_has_numtaskfin();
  numtaskfin_ = value;
}
